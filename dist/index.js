...
unwrapExports(utils);
utils.toCommandProperties;
utils.toCommandValue;
...
unwrapExports(oidcUtils);
oidcUtils.OidcClient;
...
unwrapExports(summary);
summary.summary;
summary.markdownSummary;
summary.SUMMARY_DOCS_URL;
...
var core_18 = core.getInput;
core.addPath;
core.setSecret;
core.exportVariable;
core.ExitCode;

const username = core_18('username');
core_7(`[force-sync-gitee-action]: Your username is ${username}`);
